    ...
    <Section id="partners">
      <Container>
        ...
        <InnerSection>
          ...
          <CuratingSection>
            <a
              href="https://www.soundr.space/"
              target="_blank"
              rel="noreferrer"
            >
              <CuratingImage src={soundr} />
            </a>
            <a href="https://limewire.com/" target="_blank" rel="noreferrer">
              <CuratingImage src={limewire} />
            </a>
            <a
              href="https://www.ozzfest.com/welcome.html"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://www.overthereality.ai/"
              target="_blank"
              rel="noreferrer"
            >
              <CuratingImage src={over} />
            </a>
            <a href="https://metatokyo.xyz/" target="_blank" rel="noreferrer">
              <CuratingImage src={meta} />
            </a>
            <a
              href="https://randomravers.com/"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://partydegenerates.com"
              target="_blank"
              rel="noreferrer"
            >
              <CuratingImage src={unpaired} />
            </a>
            <a href="https://www.multinft.io/" target="_blank" rel="noreferrer">
            ...
            <a
              href="https://www.vegascity.org/about"
              target="_blank"
              rel="noreferrer"
            >
        ...
        <InnerSection>
          ...
          <ThanksSection>
            <ThanksItem href="http://move.ai/" rel="noreferrer">
              Move.ai -
            </ThanksItem>
            <ThanksItem href="https://www.kinetix.tech/" rel="noreferrer">
              Kinetix -
            </ThanksItem>
            <ThanksItem>Burble -</ThanksItem>
            <ThanksItem>Klezma -</ThanksItem>
            <ThanksItem>Music Finland -</ThanksItem>
            <ThanksItem>Beam Studio -</ThanksItem>
            <ThanksItem>DappCraft -</ThanksItem>
            <ThanksItem>Polygonal Mind -</ThanksItem>
            <ThanksItem>Vroomway</ThanksItem>
          </ThanksSection>
        </InnerSection>
      </Container>
    </Section>
